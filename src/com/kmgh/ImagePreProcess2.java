...
public class ImagePreProcess2 {
    ...
    public static BufferedImage removeBackgroud(File picFile)  
            throws Exception {  
    ...
    public static Map<BufferedImage, String> loadTrainData() throws Exception {  
        if (trainMap == null) {  
            ...
            //String train_path = FileUtil.getFilePath("config.properties", "train_path");
            File dir = new File("E:/train");  
...
//        ImageIO.write(img, "JPG", new File("E:\\result\\" + result + ".jpg"));  
        return result;  
    }  
